...
export default function SinglePromptAgentPage() {
  ...
  // Fetch agent info
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_API_URL}/api/agents/${bot_id}`, { withCredentials: true })
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await axios.put(`${import.meta.env.VITE_API_URL}/api/agents/${bot_id}`, agent, { withCredentials: true });
