...
const ProfilePage = () => {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      const res = await axios.put(`${process.env.VITE_API_URL || "http://localhost:3000"}/auth/me`, profile, { withCredentials: true });
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      await axios.put(`${process.env.VITE_API_URL || "http://localhost:3000"}/auth/me/password`, passwords, { withCredentials: true });
  ...
  const handleLogout = async () => {
    try {
      await axios.post(`${process.env.VITE_API_URL || "http://localhost:3000"}/auth/logout`, {}, { withCredentials: true });
