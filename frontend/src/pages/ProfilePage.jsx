...
const ProfilePage = () => {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      const res = await axios.put(`${import.meta.env.VITE_API_URL}/api/auth/me`, profile, { withCredentials: true });
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      await axios.put(`${import.meta.env.VITE_API_URL}/api/auth/me/password`, passwords, { withCredentials: true });
