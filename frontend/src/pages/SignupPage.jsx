...
const icons = [
  { id: "google", light: googleLight, bold: googleBold, alt: "Sign up with Google", href: `${process.env.VITE_API_URL || "http://localhost:3000"}/auth/google` },
  { id: "github", light: githubLight, bold: githubBold, alt: "Sign up with GitHub", href: `${process.env.VITE_API_URL || "http://localhost:3000"}/auth/github` },
  { id: "dropbox", light: dropboxLight, bold: dropboxBold, alt: "Sign up with Dropbox", href: `${process.env.VITE_API_URL || "http://localhost:3000"}/auth/dropbox` },
];
