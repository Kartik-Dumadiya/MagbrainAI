...
const AgentsPage = () => {
    ...
    const handleTemplateSelect = async (agentType, templateKey) => {
        ...
        try {
            const res = await axios.post(`${import.meta.env.VITE_API_URL || "http://localhost:3000"}/agents`, agentData, { withCredentials: true });
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL || "http://localhost:3000"}/agents/${agent.bot_id}`, { withCredentials: true });
