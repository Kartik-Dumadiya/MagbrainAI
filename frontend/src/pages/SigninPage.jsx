...
const icons = [
  {
    ...
    href: process.env.VITE_API_URL ||"http://localhost:3000/auth/google",
  },
  {
    id: "github",
    light: githubLight,
    ...
    href: process.env.VITE_API_URL || "http://localhost:3000/auth/github",
  },
  {
    id: "dropbox",
    light: dropboxLight,
    ...
    href: process.env.VITE_API_URL || "http://localhost:3000/auth/dropbox",
  },
];
